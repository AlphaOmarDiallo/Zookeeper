...
fun main() {
    ...
    do {
        ...
        when(input){
            "0" -> println(animals[input.toInt()])
            "1" -> println(animals[input.toInt()])
            "2" -> println(animals[input.toInt()])
            "3" -> println(animals[input.toInt()])
            "4" -> println(animals[input.toInt()])
            "5" -> println(animals[input.toInt()])
            else -> {
